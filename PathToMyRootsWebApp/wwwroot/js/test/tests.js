...
function getHourglassBiologicalTestContexts() {
    ...
    const testsData = [
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When only male ancestors are present, fake ancestors are added' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When only female ancestors are present, fake ancestors are added' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has siblings from multiple parents, only ancestors of biological parents are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are second married and person does not have siblings, other spouses of parents are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are second married and person has sibling only from mothers first marriage, fathers first spouse is not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are second married and person has sibling from fathers first marriage, mothers first spouse is not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are second married and person has siblings from other spouses of parents, other spouses are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are first married and person does not have siblings, other spouses of parents are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are first married and person has sibling from mothers second marriage, fathers second spouse is not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are first married and person has sibling from fathers second marriage, mothers second spouse is not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents are first married and person has siblings from other spouses of parents, other spouses are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When male has two wives, but has children only with the first wife, only the first wife and children is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When male has two wives, but has children only with the second wife, only the second wife and children is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When male has two wives, and has children with both, both wives and children are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When male has two wives, but has children with none of them, none of them is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When female has two husbands, but has children only with the first husband, only the first husband and children is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When female has two husbands, but has children only with the second husband, only the second husband and children is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When female has two husbands, and has children with both, both husbands and children are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When female has two husbands, but has children with none of them, none of them is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has sibling with spouses, sibling is displayed without his spouses and siblings are sorted' },
        { ancestorsDepth: 0, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When ancestors depth is 0, siblings of person are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has multiple children, children are sorted by their birthDates' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has child with spouse and they do not have children, child without spouse is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has child with spouse and they have children, child with spouse and their children is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: 1, testTitle: 'When person has child with spouse, they have children and descendants depth is 1, children without spouse is displayed' },
        ...
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When male sibling of person has child with persons child, duplicated male siblings are marked and connected to each other' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When female sibling of person has child with persons child, duplicated female siblings are marked and connected to each other' },
        ...
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When two children and one duplicated pair are in the same generation, horizontal children and duplicated paths are displayed correctly' },
    ...
    testsData.forEach(testData => {
        ...
        testContexts.push(createTestContext(testData.testTitle, personId, testPrefix, treeType, testData.ancestorsDepth, testData.descendantsDepth));
    })
...
function getHourglassExtendedTestContexts() {
    ...
    const testsData = [
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When ancestors have multiple spouses, their spouses are displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When ancestors have adoptive parents, the ancestors of the adoptive parents are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When parents of adoptive parents are displayed, paths are displayed between them' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When adoptive grandparent has hidden biological child, adoptive path is horizontally centered' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has biological siblings, they and their spouses and displayed and sorted by birthDates' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has adoptive siblings, they and their spouses and displayed and sorted by birthDates' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has adoptive and biological siblings, they are all displayed' },
        { ancestorsDepth: 0, descendantsDepth: 0, testTitle: 'When ancestors depth is 0, siblings of person are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has adoptive child, adoptive child is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has adoptive grandchild, adoptive grandchild is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has adoptive descendants, its descendants are not displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has biological and adoptive descendants, they are all displayed and sorted by birthDates' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When sibling is adopting child of person, adoptive path is displayed' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When grandchild is adopted by siblings and first sibling is the biological parent, grandchild is displayed only once' },
        ...
        // ancestors depth 4 is enough, because in this case there will be already duplicated ancestors on 3 levels, this covers testing duplicates on a tree with 6 levels
        { ancestorsDepth: 4, descendantsDepth: 0, testTitle: 'When ancestors are duplicated, they are marked and connected to each other' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has sibling from his father and female sibling, duplicated father and female siblings are marked and connected to each other' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When person has child with his own sibling, sibling and child are displayed only once' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When children of descendants are married and do not have children, they are displayed only once and separately' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When children of descendants are married and have children, they are displayed only once and married' },
        ...
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: 1, testTitle: 'When children are married and do have children, they are displayed only once and not married, with descendants depth 1' },
        { ancestorsDepth: relativesDepth.ALL.index, descendantsDepth: relativesDepth.ALL.index, testTitle: 'When children are married and do have children, they are displayed only once and married, with descendants depth All' },
...
function createTestContext(testTitle, personId, testPrefix, treeType, ancestorsDepth, descendantsDepth) {
    return {
        testTitle: testTitle,
        personId: personId,
...
async function runTest(testNumber, testCaseDiv, scrollableContent, testContext, testProgressContext) {
    ...
    if (testContext.treeType != treeTypes.COMPLETE) {
        ...
        await createAndDisplayDiagramFrame(originalDiagramsDiv, testContext.personId, originalDiagramFrameIdSuffix, treeTypes.COMPLETE, true, true, relativesDepth.ALL.index, relativesDepth.ALL.index, viewModes.MEDIUM);
    }
    ...
    await createAndDisplayDiagramFrame(resultDiagramsDiv, testContext.personId, resultDiagramFrameIdSuffix, testContext.treeType, true, true, testContext.ancestorsDepth, testContext.descendantsDepth, viewModes.MEDIUM);

function addSettingsListeners() {
    ...
    settingsDivs.forEach(settingsDiv => {
        // init consts
        const expandButtonDiv = settingsDiv.querySelector('.expand-button-div');
        const horizontalToggleableContainer = settingsDiv.querySelector('.horizontal-toggleable-container');
        const contentInnerDiv = settingsDiv.querySelector('.content-inner-div');
        const treeTypesRadioButtons = contentInnerDiv.querySelector('.selected-tree-type');

        expandButtonDiv.addEventListener('click', () => {
            expandButtonDiv.classList.toggle('expand-button-div-opened')
            horizontalToggleableContainer.classList.toggle('horizontal-toggleable-container-open');
        });
